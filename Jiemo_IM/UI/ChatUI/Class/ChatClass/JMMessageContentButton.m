...
@implementation JMMessageContentButton
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.voice.image = [UIImage imageWithName:@"chat_animation_white3"];
        self.voice.animationImages = [NSArray arrayWithObjects:
                                      [UIImage imageWithName:@"chat_animation_white1"],
                                      [UIImage imageWithName:@"chat_animation_white2"],
                                      [UIImage imageWithName:@"chat_animation_white3"],nil];
